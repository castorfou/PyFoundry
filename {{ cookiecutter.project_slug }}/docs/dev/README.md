!!! info "À propos de cette section"
    Cette section contient la documentation pour les **développeurs** qui contribuent au projet {{ cookiecutter.project_name }}.
...
{% raw %}{% include "../bonnes_pratiques.md" %}{% endraw %}